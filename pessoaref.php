            ...
            <br>
                ...
                <form id="edit-profile" class="form-horizontal">
                  <fieldset>
                    ...
                    <div class="control-group">                     
                      <label class="control-label">Tipo de unidade</label>
                                            ...
                                            <label class="radio inline">
                                              <input type="radio" name="radiobtns"> CRAS
                                            </label>
                                            
                                            <label class="radio inline">
                                              <input type="radio" name="radiobtns"> CREAS
                                            </label>
                                          </div>  <!-- /controls -->      
                    </div>
                    ...
                    <div class="control-group">                     
                      <label class="control-label" for="email">Número da unidade:</label>
                      <div class="controls">
                        <input type="text" class="span4" id="email" placeholder="O número da unidade">
                      </div> <!-- /controls -->       
                    </div> <!-- /control-group -->
                    ...
                    <div class="control-group">                     
                      ...
                      <div class="controls">
                        <input type="text" class="span4" id="email" placeholder="Nome completo da unidade">
                      </div> <!-- /controls -->       
                    </div> <!-- /control-group -->
                    ...
                    <div class="control-group">                     
                      <label class="control-label">Localização do domicilio</label>
                                            ...
                                            <div class="controls">
                                            <label class="radio inline">
                                              <input type="radio" name="radiobtns"> Urbano
                                            </label>
                                            
                                            <label class="radio inline">
                                              <input type="radio" name="radiobtns"> Rural
                                            </label>
                                          </div>  <!-- /controls -->      
                    </div>
